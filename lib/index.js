...
var DingTalkRobot = function () {
  ...
  _createClass(DingTalkRobot, [{
    ...
    key: "send",
    value: async function send(contentBody) {
      var url = "https://oapi.dingtalk.com/robot/send?access_token=" + this.accessToken;
      var headers = { "Content-Type": "application/json" };
      try {
        var response = await axios.post(url, contentBody, { headers: headers });
